...
const InvitePage = () => {
    ...
    // Use the LeaderboardContext to get leaderboard data, including friends_stats
    const { friends_stats } = useContext(LeaderboardContext);

    // Ensure that friends_stats is an array
            ...
            <div className="_gameView_1cr97_1" id="game-view">
                <div className="_view_sf2n5_1 _view_1x19s_1" style={{opacity: 1}}>
                    ...
                    <div className="_buttonWrap_1x19s_70">
                        <div className="_root_oar9p_1 _type-white_oar9p_43" onClick={handleGoToScore}>Invite friends
                        </div>
                    </div>
                </div>
            </div>
